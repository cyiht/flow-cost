...
const AddBill: React.FC<AddBillProps> = ({ language, onSave }) => {
  ...
  const handleConfirm = () => {
    ...
    const billData: Bill = {
      id: editBill?.id || Math.random().toString(36).substr(2, 9),
      name: name,
      amount: numAmount,
      date: `${month} ${day}`,
      timeLeft: timeLeft,
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#f6f6f8] text-[#121217] relative overflow-hidden dark:bg-background-dark dark:text-white">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800')" }}></div>
